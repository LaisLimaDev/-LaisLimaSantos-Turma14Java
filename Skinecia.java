...
public class Skinecia {
	public static void main(String[] args)
	{
			//variveis
			Scanner leia = new Scanner(System.in);
			String codigos[] = new String[10];
			String produtos[] = {"Protetor solar facial","Protetor solar corporal","Hidratante corporal","hidratante facial","sérum","sabonete","tonico","protetor labial","óleo facial","óleo corporal"};
			double precoUnitarios[] = {40,40,20,50,60,40,30,20,30,40};
			...
			linhaDetalhe();
			System.out.println("Loja Skin e cia");
			linhaDetalhe();
			System.out.println();
			// menu inicial
